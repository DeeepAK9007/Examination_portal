function AddCourseDet()
{
    return(
                <div>
                    <p className="p-0 ms-5 mb-0 mt-5" style={{paddingTop:'1px'}}>Add Course Details </p>
                    <hr style={{width:'95%', margin:'auto'}}/>

                    <form className="d-flex flex-row jutify-content-evenly w-100">
                        <div className="d-flex flex-column ms-5 w-50">
                            <div className="mb-3 mt-5">
                                <input type="email" className="form-control" id="exampleInputEmail1" placeholder="Course Code" />
                            </div>                        
                        </div>
                        <div className="d-flex flex-column ms-5 w-50 me-5">
                            <div className="mb-3 mt-5">
                                <input type="email" className="form-control" id="exampleInputEmail1" placeholder="Course Name" />
                            </div>
