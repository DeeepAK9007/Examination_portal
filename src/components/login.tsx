function Login()
{
    ...
    return(
            <div className="" style={{backgroundImage:'linear-gradient(to bottom right,#ADD8E6,white)',height:'100vh'}}>
                <br/><br/>
                <div className="d-flex flex-row justify-content-center shadow-sm bg-body-tertiary rounded w-75" style={{height:'80vh', margin:'auto'}}>
                    
                    <div className="d-flex flex-column justify-content-between rounded-start h-100 w-100" style={{backgroundColor:'#074E85'}}>
                        <div>
                        ...
                        <div>
                            ...
                            <p style={{textAlign:'center', color:'white'}}> © 2024 Copyright: International Institute of Information Technology - Bangalore Technical Support - application@iiitb.ac.in</p>
                        </div>
