function AddTerm()
{
    return(
                <div>
                    <p className="p-0 ms-5 mb-0 mt-5" style={{paddingTop:'1px'}}>Add Term Detail</p>
                    ...
                    <form className="d-flex flex-row jutify-content-evenly w-100">
                        ...
                        <div className="d-flex flex-column ms-5 w-50 me-5">
                            <div className="mb-3 mt-5">
                                <input type="password" className="form-control" id="exampleInputPassword1" placeholder="Date Time"/>
                            </div>  
